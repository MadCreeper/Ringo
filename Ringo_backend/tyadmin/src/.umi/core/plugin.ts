...
plugin.register({
  apply: require('D:/Ringo/Ringo/tyadmin/src/.umi/plugin-dva/runtime.tsx'),
  path: 'D:/Ringo/Ringo/tyadmin/src/.umi/plugin-dva/runtime.tsx',
});
plugin.register({
...
plugin.register({
  apply: require('D:/Ringo/Ringo/tyadmin/src/.umi/plugin-locale/runtime.tsx'),
  path: 'D:/Ringo/Ringo/tyadmin/src/.umi/plugin-locale/runtime.tsx',
});
plugin.register({
