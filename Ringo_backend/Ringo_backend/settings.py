...
# MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_ROOT = os.path.join('/root/projects/Ringo/', 'media')
MEDIA_URL = 'http://{0}/root/projects/Ringo/media/'.format(QINIU_BUCKET_DOMAIN)
...
REMOTE_DEBUG = True
PROJECT_ROOT = os.path.join(BASE_DIR, 'Ringo')
...
TY_ADMIN_CONFIG = {
    'GEN_APPS': ['goods','user_operation', 'users']
}
