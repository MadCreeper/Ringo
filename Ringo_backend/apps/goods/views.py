...
from goods.serializers import GoodsSerializer, CategorySerializer , IndexCategorySerializer
...
# class offeringViewSet(mixins.ListModelMixin, mixins.RetrieveModelMixin, mixins.CreateModelMixin, mixins.DestroyModelMixin,
